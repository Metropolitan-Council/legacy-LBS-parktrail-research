...
#### summer 2021 ####
summer21_trails1 <- bind_rows(dnr_demos_homes$summer21_activity, 
...
summer21_trails <- summer21_trails1 %>%
  ...
  mutate(bike_use = bike * days_in_summer,
  ...
  summarise(volume = sum(bike_use, ped_use),
  ...
  mutate(modeshare_bike_use = bike_use / volume,
  ...
  mutate(modeshare_bike_use = ifelse(volume == 0, NA, modeshare_bike_use), 
...
#### year 2021 ####
full21_trails1 <- bind_rows(dnr_demos_homes$full21_activity, 
...
#### summer 2021 ####
summer_trail_demographics1 <- bind_rows(dnr_demos_homes$summer21_demos, 
...
#### full 2021 ####
full_trail_demographics1 <- bind_rows(dnr_demos_homes$full21_demos, 
