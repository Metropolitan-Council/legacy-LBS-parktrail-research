...
create_unit_fig <- function(name){
  ...
  explain_text <- paste("This factsheet summarizes trail-level data for",  meta$unit_label, paste0(meta$unit_type_label, "."),
  ...
  print("location map")
  location_map_text <- paste(meta$unit_label, "is part of the", meta$system_label, "Trail system", paste0("(", meta$district, ")."),
  ...
  if (meta$system == "Metro Regional") {
    save_plot(figure, filename = paste0(here::here(), "/figures/factsheets/", meta$system, "-trails/", stringr::str_replace(meta$unit_id, "/", "-"), "_", meta$short_agency, ".pdf"),
              base_height = 23, base_width = 17)
  } else {
    save_plot(figure, filename = paste0(here::here(), "/figures/factsheets/", meta$system, "-trails/", stringr::str_replace(meta$unit_id, "/", "-"), ".pdf"),
              base_height = 23, base_width = 17)
