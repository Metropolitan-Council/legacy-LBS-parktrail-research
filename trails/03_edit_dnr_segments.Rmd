...
dnr_add <- rbind(dnr_add, 
                    data.frame(unit_id = sample$unit_id[1], 
                               osm_id = c(172878239, 18127123, 172876511, 
                                          172875876, 172876514, 18008606, 
                                          172876515, 172875875, 172875874, 
                                          18131247, 18126307, 215588759)))

dnr_new_to_pull <- data.frame(unit_id = sample$unit_id[1], 
                              osm_id = 215588759)
...
dnr_remove <- rbind(dnr_remove, 
                    data.frame(unit_id = sample$unit_id[1], 
                               osm_id = c(18134822, 129898311, 213216627, 
...
dnr_add <- rbind(dnr_add, 
                    data.frame(unit_id = sample$unit_id[1], 
                               osm_id = c(1103961460, 167849986, 781987319,
...
dnr_new_to_pull <- rbind(dnr_new_to_pull, 
                         data.frame(unit_id = sample$unit_id[1], 
                                    osm_id = 182478688))
...
dnr_new_to_pull <- rbind(dnr_new_to_pull, 
                         data.frame(unit_id = "Chester-Woods_trail_DNR", 
...
dnr_new_to_pull <- dnr_new_to_pull %>%
  rbind(data.frame(unit_id = sample$unit_id[1], 
...
dnr_remove <- rbind(dnr_remove, 
                    data.frame(unit_id = sample$unit_id[1], 
                               osm_id = c(18231848, 18238387, 214340509, 
...
dnr_new_to_pull <- dnr_new_to_pull %>%
  rbind(
    data.frame(
      ...
      osm_id = c(1137753032, 1137753095, 1137753056, 
...
dnr_add <- rbind(dnr_add, 
                    data.frame(unit_id = sample$unit_id[1], 
                               osm_id = c(18246744, 18250266, 18251230, 
...
dnr_add <- rbind(dnr_add, 
                    data.frame(unit_id = sample$unit_id[1], 
                               osm_id = c(18195970, 182810610, 881474893, 
                                          881474895)))
...
dnr_remove <- rbind(dnr_remove, 
                    data.frame(unit_id = sample$unit_id[1], 
                               osm_id = c(218816111, 218816129, 218816988, 
...
dnr_remove <- rbind(dnr_remove, 
                    data.frame(unit_id = sample$unit_id[1], 
                               osm_id = c(71688221, 297942249, 485973500, 
...
dnr_add <- rbind(dnr_add, 
                    data.frame(unit_id = sample$unit_id[1], 
                               osm_id = c(98260424, 98260426, 155240552, 
...
dnr_add <- rbind(dnr_add, 
                    data.frame(unit_id = sample$unit_id[1], 
                               osm_id = c(18028873, 18038771, 99065805, 
                                          99137025)))
...
dnr_remove <- rbind(dnr_remove, 
                    data.frame(unit_id = sample$unit_id[1], 
                               osm_id = c(705637673, 721321833, 721382754, 
...
dnr_add <- dnr_add %>%
  rbind(data.frame(
    unit_id = sample$unit_id[1],
    osm_id = c(351778944, 448898494, 72833909, 
...
dnr_add <- dnr_add %>%
  rbind(data.frame(
    unit_id = sample$unit_id[1], 
    osm_id = c(277636913, 277636915, 277636911, 
...
dnr_remove <- rbind(dnr_remove, 
                    data.frame(unit_id = sample$unit_id[1], 
                               osm_id = c(835799794, 931492553, 98942488, 
                                          98942519)))
...
taconite <- c(216970926, 18113825, # less than half
              215034555, 216995848, 18103668, # ~half
              215232770, 18241810, # mostly good
              217021508, 217020767, 18105921, 362142043, 362142042, 845487243) # actual match
...
dnr_remove <- rbind(dnr_remove, 
                    data.frame(unit_id = sample$unit_id[1], 
                               osm_id = c(18252233, 145168457, 175836808, 
