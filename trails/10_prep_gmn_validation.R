...
if (fetch_greatermn_validation == TRUE) {
  ...
  gmn_sadt <- data.frame(
    zone_name = rep(c(
      "Jackpot Trail_975834790_23",
      "Talus Trail_793102556_4",
      "Short Stacker Bike Trail_975834775_22",
      "High Climber Trail_875602096_19"
    ), each = 3),
    line_zone_name = rep(c(
  ...
  zones <- c(
    "St. Louis River Trail (Duluth Traverse)_946818017", # mission creek
    ...
    "Hawk Ridge Trail (Duluth Traverse)_824183333"
  ) # hawk ridge
  ...
  dt_sadt <- data.frame(
    zone_name = rep(c(
      "St. Louis River Trail (Duluth Traverse)_946818017",
