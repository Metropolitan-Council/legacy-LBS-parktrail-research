...
mndot_rm <-roads %>%
  filter(!ROUTE_NAME %in% c("Saint Paul M 645-I", "Saint Paul M 645-D", 
...
mndot_rm <-roads %>%
  filter(!ROUTE_NAME %in% c("Saint Paul M 381-I", "Saint Paul M 381-D", 
...
mndot_rm <-roads %>%
  filter(!ROUTE_NAME %in% c("Minneapolis M 1979-I", "Minneapolis M 1979-D", 
...
mndot_rm <-roads %>%
  filter(!ROUTE_NAME %in% c("Lino Lakes M 395-I", "Lino Lakes M 395-D", 
...
mndot_rm <-roads %>%
  filter(!ROUTE_NAME %in% c("Vadnais Heights M 229-I", "Vadnais Heights M 229-D", 
...
mndot_rm <-roads %>%
  filter(!ROUTE_NAME %in% c("Dakota T 1646-D", "Dakota T 1646-I", 
...
list_of_files <- as.list(paste0(here(), "/data-temp/metro-park-geography/", 
...
st_write(metro_parks, paste0(here(), "/data-intermediate/partial-park-zones/metro_", 
...
```{r}
metro_parks <- read_sf(paste0(here(), "/data-intermediate/partial-park-zones/metro_", 
