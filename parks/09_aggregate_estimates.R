...
weekly_volume <- all_modes_expanded %>%
  ...
  summarise(
    weekly_vehicle_visitors = sum(vehicle_visitors),
...
monthly_volume <- all_modes_expanded %>%
  ...
  summarise(
    monthly_vehicle_visitors = sum(vehicle_visitors),
...
season_volume <- all_modes_expanded %>%
  ...
  summarise(
    season_vehicle_visitors = sum(vehicle_visitors),
...
annual_volume <- all_modes_expanded %>%
  ...
  summarise(
    annual_vehicle_visitors = sum(vehicle_visitors),
